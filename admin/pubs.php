...
<body class="bg-darker text-white font-sans min-h-screen flex flex-col">
    ...
    <div class="container mx-auto px-4 py-8 flex-grow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-surface rounded-lg overflow-hidden border border-gray-800 flex flex-col" id="pub-card-<?php echo $pub['pub_id']; ?>">
                ...
                <div class="p-4 flex-grow pub-display" id="pub-display-<?php echo $pub['pub_id']; ?>">
                    <h3 class="text-xl font-bold text-white mb-1"><?php echo htmlspecialchars($pub['pub_name']); ?></h3>
                ...
                <div class="p-4 flex-grow pub-edit-form hidden" id="pub-edit-<?php echo $pub['pub_id']; ?>">
                    <form method="POST" class="space-y-3">
                        ...
                        <div>
                            <label class="block text-gray-400 text-xs mb-1">Pub Name</label>
                            <input type="text" name="name" required class="input-field" value="<?php echo htmlspecialchars($pub['pub_name']); ?>">
                        </div>
                        <div>
                            <label class="block text-gray-400 text-xs mb-1">Location</label>
                ...
                <div class="p-4 border-t border-gray-700 bg-black/20 flex justify-between items-center">
